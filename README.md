...
```
// 命名空间
use eg\tencent\map\WebService\AddressOption;
use eg\tencent\map\WebService\Address;
...
```
// 命名空间
use eg\tencent\map\WebService\LocationOption;
use eg\tencent\map\WebService\Location;
...
```
// 命名空间
use eg\tencent\map\WebService\TranslateOption;
use eg\tencent\map\WebService\Translate;
...
```
// 命名空间
use eg\tencent\map\WebService\IpOption;
use eg\tencent\map\WebService\Ip;
